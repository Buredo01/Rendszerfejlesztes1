...
- Kimenet: Nem listáz ki semmit, nem létezik ilyen kiadó az adatbázisunkban
...
- Kimenet: Megjeleníti a `A kívülálló` című könyvvet
...
- Kimenet: `Jennifer L Armentrout` könyveinek kilistázása
...
- Kimenet: Könyvek megjelenítése, amelyek címében szerepel a `tanú` kulcsszó
...
- Kimenet: Olyan szerzők könyveinek megjelenítése, akiknek nevében szerepel a `King` kulcsszó
...
- Kimenet: Olyan kiadók könyveinek megjelenítése, amelyben szerepel a `Kossuth` kulcsszó